...
import { ExamType, Level, SkillLevel, Range, Context, Question, Answer } from '../models/question-bank.model';
...
export class AdminService {
  ...
  postQuestion(question: Question): Observable<string> {
    return this.http.post<string>(`${this.apiUrl}/Question`, question, { withCredentials: true });
  }
  ...
  deleteQuestion(id: string): Observable<void> {
    return this.http.delete<void>(`${this.apiUrl}/Question/${id}`, { withCredentials: true });
  }
  ...
  deleteAnswer(id: string): Observable<void> {
    return this.http.delete<void>(`${this.apiUrl}/Answer/${id}`, { withCredentials: true });
  }
}
